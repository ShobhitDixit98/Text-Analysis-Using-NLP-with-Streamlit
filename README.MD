...
1. **Clone the repository:**
    ```bash
    git clone https://github.com/shobhit-dixit/Text_Analysis_Using_NLP_Streamlit.git
...
For any questions or feedback, please feel free to reach out via GitHub issues or contact the maintainer directly at iamshobhit98@gmail.com.

## About the Developer

This project is maintained by Shobhit Dixit, an AI/ML Engineer with nearly 5 years of experience building scalable machine learning and generative AI solutions. Shobhit specializes in Python, PyTorch, and AWS, with a focus on developing production ML pipelines, RAG architectures, and real-time inference systems. Based on original work in the NLP community, this repository is updated to reflect modern best practices in text analytics and Streamlit deployment.